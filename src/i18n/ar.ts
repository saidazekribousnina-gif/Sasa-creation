...
export const ar: Translations = {
  ...
  navigation: {
    ...
    searchPlaceholder: "ابحثي عن قلادات، أقراط، خواتم…",
    cartEmptyText: "سلتك فارغة — تعالي اكتشفي إبداعاتنا.",
  ...
  hero: {
    ...
    title: "كل قطعة تحكي\nحكاية",
    ctaPrimaryText: "اكتشفي المجموعة",
  ...
  videoSection: {
    ...
    bodyParagraphs: [
      ...
      "لأن كل قطعة مصنوعة يدويًا، فإن الاختلافات الصغيرة جزء من سحرها. حليّك سيكون فريدًا — لن يُنتج بالجملة أبدًا، ولن يُصنع على عجل أبدًا.",
    ],
    ctaText: "شاهدي الإبداعات",
    ctaTarget: "#products",
  ...
  craftSteps: {
    ...
    introText:
      "تابعي التمرير — كل إبداع يمرّ بهذه الحركات الاثنتي عشرة، في ورشتنا، دون أي اختصار.",
    backgroundImage: "/images/atelier.jpg",
    ...
    steps: [
      ...
      },
      {
        ...
        title: "قصّ الخيط",
        description:
          "يُقصّ خيط الحرير بالطول الدقيق — لا مشدودًا أكثر من اللازم ولا مرتخيًا أكثر من اللازم.",
      },
      {
        number: 5,
        title: "التنظيم",
        description:
          "حبّة بعد حبّة، يستقر الإيقاع. إنه أطول الحركات وأكثرها تأملًا.",
      },
      {
        number: 6,
        title: "العقد",
      ...
      },
      {
        ...
        title: "علبة الهدايا",
        description:
          "توضع القطعة في علبة هداياها، على فراش من ورق الحرير.",
      },
      {
        number: 12,
        title: "الإرسال",
        description:
          "من أيدينا إلى أيديكم — مغلّفة بالعناية نفسها التي نغلف بها هدية لعزيز من العائلة.",
      },
    ],
  },
  ...
  products: {
    ...
    viewAllText: "شاهدي كل الإبداعات",
    addToCartText: "أضيفي إلى السلة",
    ...
    posts: [
      {
        ...
        image: "/images/product-1.png",
        excerpt:
          "من الرسم الأول إلى العقدة الأخيرة — اكتشفي الخطوات الاثنتي عشرة الدقيقة التي تقف خلف كل قلادة نصنعها يدويًا.",
      },
      {
        id: 2,
        ...
        image: "/images/product-5.jpg",
        excerpt:
          "عادات بسيطة — تُلبس أخيرًا وتُخلع أولًا، مع قماش ناعم — تكفي لتحافظ على بريق خرزاتك وطلاءاتك الذهبية لسنوات.",
      },
      {
        id: 3,
  ...
  faq: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "بالطبع — القطع الخاصة هي مشاريعنا المفضلة. سواء كانت هدية أو طقم زفاف أو إبداعًا مُعادًا صياغته من ذكرى عائلية، راسلونا عبر نموذج الاتصال وسنبدع شيئًا معًا.",
      },
      {
        id: 4,
        question: "ما هي آجال التوصيل؟",
        answer:
          "القطع الجاهزة تُشحن خلال يوم عمل إلى يومين وتصل عادة خلال 2 إلى 4 أيام في جميع أنحاء تونس. الطلبات الخاصة تحتاج من أسبوع إلى أسبوعين من الإبداع قبل الشحن. كل طلب يصل في علبة هدايا.",
      },
      {
        id: 5,
        question: "ماذا لو انكسر حليّي؟",
        answer:
          "نقدّم وعد إصلاح لمدة عام على كل قطعة. إذا انفلت قفل أو خيط أو عقدة، أعيديها لنا وسنصلحها مجانًا — تدفعين الشحن فقط.",
      },
    ],
  },
  ...
  contact: {
    ...
    formFields: {
      ...
      messagePlaceholder:
        "حدثينا عن القطعة التي تتخيلها — المناسبة، الألوان، الميزانية…",
    },
  ...
  footer: {
    ...
    newsletterHeading: "انضمي إلى عائلة ساسا",
    newsletterDescription:
      "إبداعات جديدة، حكايات من الورشة، ووصول مبكر إلى الكميات الصغيرة — مرة في الشهر، دون إزعاج.",
    newsletterPlaceholder: "بريدك الإلكتروني",
    newsletterButtonText: "اشتركي",
    newsletterSuccessText: "أهلًا بك في العائلة! ✓",
    linkGroups: [
      {
        title: "المتجر",
        links: [
    ...
    copyrightText: "© 2026 ساسا كريشن. مصنوع يدويًا بحب.",
    socialLinks: [
      { icon: "Instagram", label: "Instagram", href: "https://instagram.com" },
      { icon: "Facebook", label: "Facebook", href: "https://facebook.com" },
    ],
